...
@SourceType(value = "AsanaARP", label = "Asana",uiConfig = "asana-layout.json")
public class AsanaConf extends AbstractArpConf<AsanaConf> {
  private static final String ARP_FILENAME = "arp/implementation/asana-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.asana.AsanaDriver";
